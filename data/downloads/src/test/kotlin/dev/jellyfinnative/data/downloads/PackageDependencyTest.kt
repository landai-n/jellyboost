...
class PackageDependencyTest {
    ...
    private companion object {
        /** The name this test uses for the `dev.jellyfinnative.data.downloads` package itself. */
        const val ROOT = "<root>"
         ...
         */
        fun sourceRoot(): File {
            val suffix = "src/main/kotlin/dev/jellyfinnative/data/downloads"
    ...
    private class PackageGraph(
        ...
        companion object {
            private const val PREFIX = "dev.jellyfinnative.data.downloads"
