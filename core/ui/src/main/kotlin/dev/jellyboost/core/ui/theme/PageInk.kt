 ...
 * worked example — 0.48 is 5.00:1 on `#101010` and only 3.66:1 on `#F6F7F8`, so the light side runs
 * at 0.60 (5.62:1) to owe WCAG 1.4.3 the same 4.5:1. Tokens drawn over *media* are not this: video,
