 ...
 *
 * `UserDataRepositoryImpl` already enqueues the worker when its own push fails, which covers a
 * change made while offline. It does not cover the two cases that actually deliver the milestone's
 * definition of done:
 *
