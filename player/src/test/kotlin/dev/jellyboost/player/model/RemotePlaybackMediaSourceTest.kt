...
/**
 * `RemotePlaybackMediaSource.toString()` prints no URL — the token in a transcoding URL is a live
 * credential. Assertions check the *token*, not the wording, so a format-string rewrite can't defeat
 * the redaction.
 */
