 ...
 *
 * The field's accessibility guarantees used to be four pairs of parameters a caller had to keep in
 * agreement by hand, and the *only* thing holding them together was call-site discipline
 * (docs/notes/audit-2026-08-06-quality.md, CPX-8). Collapsing them into [FieldLabel], [FieldState]
...
class FieldSemanticsTest {
    ...
    inner class Labels {
        ...
        fun eyebrowUppercasesOnlyTheCaption() {
            ...
            // which is not a label (audit CR-2/F16). One argument, two spellings, no way to give
    ...
    inner class States {
        ...
        fun inFlight() {
            ...
            // moment they pressed the button (audit F17). This is the state that replaced it, and
        ...
        fun error() {
            ...
            // announced "invalid" and nothing else, which is worse than silence (audit CR-2).
    ...
    inner class Contents {
        ...
        fun revealedPassword() {
            ...
            // secret marking, or marked while showing its value (audit F5).
