 ...
 * package, so two apps signed with the same key — e.g. our `dev.jellyfinnative.app.debug` and the
 * locally-signed `dev.jellyfinnative.app` release variant used for profiling — receive the *same*
