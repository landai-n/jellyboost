 ...
 * (docs/PLAN.md, "Connectivity"). Modeling this as its own table — rather than a single column
 * on [ServerEntity] — keeps the schema ready for multi-server support later without a
 * migration.
 *
